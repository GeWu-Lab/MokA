...
# Import local modules instead of miniconda modules
from .. import adalora, loha, lokr, lora, oft
...
# Import local layer classes
from ..lora.layer import LoraLayer
from ..loha.layer import LoHaLayer
from ..lokr.layer import LoKrLayer
from ..adalora.layer import AdaLoraLayer
from ..oft.layer import OFTLayer
...
Layers = (LoraLayer, LoHaLayer, LoKrLayer, AdaLoraLayer, OFTLayer)
